...
function TracewellAnalysis() {
  ...
  return (
    <Card className="w-full max-w-3xl rounded-2xl border border-white/50 bg-white/85 p-6 shadow-[0_20px_60px_rgba(104,75,247,0.12)]">
      <div className="flex items-center gap-3 mb-3">
        ...
        <div>
          <h3 className="text-lg font-semibold text-gray-900">On-Chain Market Analysis</h3>
          <p className="text-xs text-gray-500">
            {ts ? new Date(Number(ts)).toLocaleString() : ""} · Verified on Ritual Chain
          </p>
        </div>
      </div>
